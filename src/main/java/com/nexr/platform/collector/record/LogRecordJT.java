...
public class LogRecordJT extends org.apache.hadoop.record.Record {
	...
	public int compareTo(final Object _rio_peer_) throws ClassCastException {
		if (!(_rio_peer_ instanceof LogRecordJT)) {
			throw new ClassCastException(
					"Comparing different types of records.");
		}
		LogRecordJT _rio_peer = (LogRecordJT) _rio_peer_;
		int _rio_ret = 0;
		_rio_ret = (time == _rio_peer.time) ? 0 : ((time < _rio_peer.time) ? -1
				: 1);
		if (_rio_ret != 0)
			return _rio_ret;
		{
	...
	public Object clone() throws CloneNotSupportedException {
		LogRecordJT _rio_other = new LogRecordJT();
			...
			try {
				...
				}
				{
					...
					for (int midx1 = 0; midx1 < mi1; midx1++) {
						{
							int i = org.apache.hadoop.record.Utils.readVInt(b,
									s);
							int z = org.apache.hadoop.record.Utils
									.getVIntSize(i);
							s += (z + i);
							l -= (z + i);
						}
			...
			try {
				...
				}
				{
					...
					for (int midx1 = 0; midx1 < mi11 && midx1 < mi21; midx1++) {
						{
							int i1 = org.apache.hadoop.record.Utils.readVInt(
									b1, s1);
							int i2 = org.apache.hadoop.record.Utils.readVInt(
									b2, s2);
							int z1 = org.apache.hadoop.record.Utils
									.getVIntSize(i1);
							int z2 = org.apache.hadoop.record.Utils
									.getVIntSize(i2);
							s1 += z1;
							s2 += z2;
							l1 -= z1;
							l2 -= z2;
							int r1 = org.apache.hadoop.record.Utils
									.compareBytes(b1, s1, i1, b2, s2, i2);
							if (r1 != 0) {
								return (r1 < 0) ? -1 : 0;
							}
							s1 += i1;
						...
						{
							int i = org.apache.hadoop.record.Utils.readVInt(b1,
									s1);
							int z = org.apache.hadoop.record.Utils
									.getVIntSize(i);
							s1 += z + i;
						...
						{
							int i = org.apache.hadoop.record.Utils.readVInt(b2,
									s2);
							int z = org.apache.hadoop.record.Utils
									.getVIntSize(i);
							s2 += z + i;
	...
	static {
		org.apache.hadoop.record.RecordComparator.define(LogRecordJT.class,
				new Comparator());
	}
}
